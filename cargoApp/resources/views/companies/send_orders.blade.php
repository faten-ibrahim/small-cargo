...
<h2 style="font-style: italic;">{{$company->comp_name}} orders</h2>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#{{ $order->order_id }}">
  Details
</button>

<!-- Modal -->
<div class="modal fade" id="{{ $order->order_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
