            ...
            columns: [{
                ...
                },
                {
                    mRender: function(data, type, row) {
                        ...
                        '<form method="POST" action="companies/'+row.id+'">@csrf {{ method_field('DELETE')}}<button style="margin-left:-25px;" type="submit" onclick="return myFunction();" class="bttn btn btn-danger btn-sm"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Delete"></i><span>Delete</span></button></form>'
